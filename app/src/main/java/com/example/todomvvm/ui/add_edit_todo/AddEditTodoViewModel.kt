...
class AddEditTodoViewModel @Inject constructor (
    ...
    savedStateHandle: SavedStateHandle // in this case it contains navigation arguments, like todo id in this case
        ): ViewModel() {

    // because if we want to add a new todo to our database, it will simply be null
